package products.creditoRotativo.pensionados;
...
public class CreditoRotativoBuilderPensionados implements IBuilderCreditoRotativo{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private CreditoRotativoPensionados creditoRotativo;
	...
	public void reset() {
		creditoRotativo = new CreditoRotativoPensionados();
	}
	...
	public CreditoRotativoPensionados getProduct() {
