package products.creditoRotativo.mayores18;
...
public class CreditoRotativoBuilderMayores18 implements IBuilderCreditoRotativo{
	
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private CreditoRotativoMayores18 creditoRotativo;
	...
	public void reset() {
		creditoRotativo = new CreditoRotativoMayores18();
	}
	...
	public CreditoRotativoMayores18 getProduct() {
