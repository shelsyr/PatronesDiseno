...
public class DebitoAhorrosBuilderMayores18 implements IBuilderDebitoAhorros{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private DebitoAhorrosMayores18 debitoAhorros;
	...
	public void reset() {
		debitoAhorros = new DebitoAhorrosMayores18();
	}
	...
	public DebitoAhorrosMayores18 getProduct() {
