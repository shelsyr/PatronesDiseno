package products.debitoAhorros.laboral;
...
public class DebitoAhorrosBuilderLaboral implements IBuilderDebitoAhorros{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private DebitoAhorrosLaboral debitoAhorros;
	...
	public void reset() {
		debitoAhorros = new DebitoAhorrosLaboral();
	}
	...
	public DebitoAhorrosLaboral getProduct() {
