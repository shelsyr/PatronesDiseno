...
public class DebitoCorrienteBuilderLaboral implements IBuilderDebitoCorriente{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private DebitoCorrienteLaboral debitoCorriente;
	...
	public void reset() {
		debitoCorriente = new DebitoCorrienteLaboral();
	}
	...
	public DebitoCorrienteLaboral getProduct() {
