...
public class CreditoBuilderPensionados implements IBuilderCredito{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private CreditoPensionados credito;
	...
	public void reset() {
		credito = new CreditoPensionados();
	}
	...
	public CreditoPensionados getProduct() {
		return this.credito;
	}
