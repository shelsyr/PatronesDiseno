...
public class CreditoBuilderEmpresarios implements IBuilderCredito{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private CreditoEmpresarios credito;
	...
	public void reset() {
		credito = new CreditoEmpresarios();
	}
	...
	public CreditoEmpresarios getProduct() {
		return this.credito;
	}
