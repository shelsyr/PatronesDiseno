...
public class CreditoBuilderMayores18 implements IBuilderCredito{
	private HashMap<String, String> datosPersonales = new HashMap<String, String>();
	private CreditosMayores18 credito;
	...
	public CreditosMayores18 getProduct() {
		return this.credito;
	}
