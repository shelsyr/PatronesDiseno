package products.cdt.pensionados;
...
public class CDTBuilderPensionados extends PerfilesCDT{

	private CDTPensionados cdt;
	
	public CDTBuilderPensionados() {
		
	}
    
    private CDTBuilderPensionados(CDTBuilderPensionados s){
        super(s);
	...
	public CDTPensionados getProduct() {
		return this.cdt;
	}
	
	@Override
    public PerfilesCDT clone() {
        return new CDTBuilderPensionados(this);
    }
